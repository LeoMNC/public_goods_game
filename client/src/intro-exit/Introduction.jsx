...
export function Introduction({ next }) {
  ...
  return (
    <div className="mt-3 sm:mt-5 p-8 space-y-6">
      ...
      <button
        ...
        className={`
          ...
          focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-empirica-500
          ${name.trim().length >= 3
            ? "bg-empirica-600 text-white hover:bg-empirica-700 cursor-pointer"
