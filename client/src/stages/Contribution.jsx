...
Empirica.onRoundStart(({ game, round }) => {  // Added game to context
  ...
  game.players.forEach((p) => {  // Use game.players instead of round.game.players
    p.set("tokens", 10);
...
Empirica.onStageStart(({ game, round, stage }) => {  // Added game to context
  ...
  const players = game.players;  // Use game.players instead of stage.game.players
...
Empirica.onRoundEnded(({ game, round }) => {  // Added game to context
  ...
  game.players.forEach(p => {  // Use game.players
